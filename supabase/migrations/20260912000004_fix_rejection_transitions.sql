-- Migration: 20260912000004_fix_rejection_transitions.sql
-- Description: Restores the missing rejected -> submitted and submitted -> rejected transition rules that were accidentally dropped in the 20260911000004 migration.
...
BEGIN
    ...
    IF NEW.status IS DISTINCT FROM OLD.status THEN
        ...
        ELSIF OLD.status = 'submitted' AND NEW.status = 'rejected' THEN
            -- Anyone can reject from submitted (Engineering, Procurement, or AI)
            NULL;
