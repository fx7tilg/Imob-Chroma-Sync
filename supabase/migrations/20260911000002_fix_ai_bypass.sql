-- =========================================================================
-- HOTFIX: Restore v_ai_bypass in decisions_column_guard
-- 
-- The 20260911000001_takeover.sql migration accidentally dropped the
-- v_ai_bypass variable and its check. This broke set_ai_readiness() RPC -
-- the RPC sets app.ai_write='on' but the column guard no longer checked
-- for it, so AI column writes were silently rejected by the trigger.
-- Result: ai_rating stayed NULL forever ("pending").
-- =========================================================================
